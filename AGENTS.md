...
- Home and Continue Watching play badges respond without an opacity/scale animation delay. Track continuous pointer activity at the stable card boundary, keep decorative card animation separate, and avoid a second thumbnail hover tracker. Speculative prewarming uses a cancellable 150 ms dwell; it must never delay pointer feedback.
